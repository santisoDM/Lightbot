...
const validateRunPositions = (serialNumber, panPosition, panSpeed, tiltPosition, tiltSpeed, lampBrightness, lampSpeed, strobe, delay) => {
  ...
  // Verificar que los valores de posición y velocidad sean números válidos o undefined (opcional)
  const isValidNumber = (value) => value === undefined || (typeof value === 'number' && !isNaN(value));
